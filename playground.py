...
def save_prompt_instructions(choice):
    """Edit the fields to extract and prompt used for that choice below."""
    dict_output = {
        1: {"fields to extract": """Document Number,Document Date,Account No.,Payment Reference,Payment Terms,GBP""",
    ...
    df.to_json('example_data/prompt_instructions.json')
